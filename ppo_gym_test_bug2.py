...
from core.unity_underwater_env_bug2 import Underwater_navigation_Bug2
...
for i in range(args.num_threads):
    env.append(Underwater_navigation_Bug2(args.depth_prediction_model, args.adaptation, args.randomization, i, args.hist_length,
